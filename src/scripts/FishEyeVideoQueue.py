...
class VideoQueue(object):
    def __init__(self):
        ...
        self.color_sub = rospy.Subscriber('/usb_cam/image_raw', Image, self.color_callback)
    ...
    def depth_callback(self, data):
        ...
        self.depth_image = self.bridge.imgmsg_to_cv2(data, desired_encoding="passthrough")
        self.depth_image = np.clip(self.depth_image, None, 10000)

        if os.path.exists(f'{self.color_dir}/0.png'):
